...
export default function MobileTinkersCorner() {
  const { t } = useLanguage();
        ...
        <div className="mx-auto max-w-full">
          ...
          >
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground/50">
            ...
            <div className="flex shrink-0 items-center gap-3">
              <img
                ...
                className="size-12 object-contain invert opacity-50"
              />
            ...
            {t.tinkers.points.map((point, i) => (
              ...
              >
                <div className="tui-panel-header justify-between">
                  <span className="text-[9px] text-tui-orange/60">
                    {point.number}
                  </span>
